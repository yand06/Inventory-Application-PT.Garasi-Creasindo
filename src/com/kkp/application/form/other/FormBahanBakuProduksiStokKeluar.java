...
public class FormBahanBakuProduksiStokKeluar extends javax.swing.JPanel {

    SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
    private final Connection conn = new ConnectDatabase().connect();

    public FormBahanBakuProduksiStokKeluar() {
        initComponents();
    ...
    private void initComponents() {
        ...
        lb.setText("Bahan Baku Produksi Stok Keluar");
