...
public class FormBahanBakuProduksiStokMasuk extends javax.swing.JPanel {

    SimpleDateFormat dateFormat = new SimpleDateFormat("yyyy-MM-dd");
    private final Connection conn = new ConnectDatabase().connect();

    public FormBahanBakuProduksiStokMasuk() {
        initComponents();
    ...
    private void initComponents() {
        ...
        txMu.setModel(new javax.swing.DefaultComboBoxModel(new String[] { "Masuk" }));
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        String sql = "insert into tabelbbP (no,tanggal,jenisKertas,ukuran,mutasi,qtyStock) values (?,?,?,?,?,?)";
        try
        {
