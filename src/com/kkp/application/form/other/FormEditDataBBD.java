...
public class FormEditDataBBD extends javax.swing.JFrame {
    ...
    public FormEditDataBBD(String nomor, Date tanggal, String jenisKertas, String ukuran, String mutasi, int jumlah) {
        initComponents();
    ...
    private void initComponents() {
        ...
        lbTambah.setText("Update - Bahan Baku Digital");
    ...
    private void btnSubmitActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnSubmitActionPerformed
        ...
        try
        {
            String sql = "UPDATE tabelbbd SET tanggal=?, jenisKertas=?, ukuran=?, mutasi=?, qtyStock=? WHERE no=?";
    ...
    public static void main(String args[]) {
        ...
        {
            java.util.logging.Logger.getLogger(FormEditDataBBD.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new FormEditDataBBD(nomor, tanggal, jenisKertas, ukuran, mutasi, jumlah).setVisible(true);
            }
        });
    }
